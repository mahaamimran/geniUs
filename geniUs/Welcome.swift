                    ...
                    ZStack{
                        ...
                        VStack{
                            ...
                            Text("geniUs")
                                ...
                                .position(x: UIScreen.main.bounds.width * 0.33, y: UIScreen.main.bounds.height * 0.61)
                            
                            Text("Get started")
                                .font(Font.system(size: 24).weight(.bold))
                                .foregroundColor(.black)
                                .frame(width: 302, height: 31, alignment: .topLeading)
                                .position(x: UIScreen.main.bounds.width * 0.46, y: UIScreen.main.bounds.height * 0.6)
                            ...
                            .position(x: UIScreen.main.bounds.width * 0.85, y: UIScreen.main.bounds.height * 0.46)
                        }
                    }
                }
            }
